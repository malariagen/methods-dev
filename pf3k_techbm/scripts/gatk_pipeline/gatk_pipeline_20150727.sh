...
# data files
export REF_GENOME="${REF_GENOME_DIR}/PlasmoDB-25_Pfalciparum3D7_Genome.fasta"
export REF_GENOME_INDEX="${REF_GENOME_DIR}/PlasmoDB-25_Pfalciparum3D7_Genome.fasta.fai"
export REF_GENOME_DICTIONARY="${REF_GENOME_DIR}/PlasmoDB-25_Pfalciparum3D7_Genome.dict"
