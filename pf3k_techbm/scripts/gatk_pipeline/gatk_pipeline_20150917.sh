...
# $HOME/src/github/malariagen/methods-dev/pf3k_techbm/scripts/gatk_pipeline/gatk_pipeline_20150917.sh >> $HOME/src/github/malariagen/methods-dev/pf3k_techbm/log/gatk_pipeline_20150917.log
