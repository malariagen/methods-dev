...
Examples:
	...
	coverageFilters.py --input_vcf_fn input.vcf --output_vcf_fn output.vcf --min_coding_coverage 215121 --max_coding_coverage 325206 --min_noncoding_coverage 65131 --max_noncoding_coverage 208337
