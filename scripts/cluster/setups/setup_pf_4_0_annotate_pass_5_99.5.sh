...
# ./scripts/cluster/setups/setup_pf_4_0_annotate_pass_5_99.5.sh

export SETUPNAME=pf_4_0_pass_5_99.5 #n
...
export FINAL_GENOTYPED_VCF_FN=${FINAL_GENOTYPES_DIR}/pf_4_0_20140712_vfp1.newCoverageFilters_pass_5_99.5.vcf #L
