...
# ./scripts/cluster/setups/setup_pf_4_0_annotate_22_99.sh

export SETUPNAME=pf_4_0_22_99 #n
...
export MIN_CODING_COVERAGE=230255 #a
export MAX_CODING_COVERAGE=538820 #z
...
export FINAL_GENOTYPED_VCF_FN=${FINAL_GENOTYPES_DIR}/pf_4_0_20140712_vfp1.newCoverageFilters_22_99.vcf #L
