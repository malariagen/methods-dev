...
# ./scripts/cluster/setups/pf_3_0_annotate.sh

export SETUPNAME=pf_3_0 #n
...
export FINAL_GENOTYPED_VCF_FN=${FINAL_GENOTYPES_DIR}/${SETUPNAME}_merged_hetuniq_newbiallelic_20130809.newCoverageFilters.vcf #L
